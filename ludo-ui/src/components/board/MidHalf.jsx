    ...
    return (
        <div className="medium-2nd">
            <div className="horizontal-path">
                ...
                <div className="cube-move-spot RGYB bluePath8 yellowPath21 greenPath34 redPath47 common-47"></div>
                <div className="cube-move-spot RGYB bluePath7 yellowPath20 greenPath33 redPath46 common-46"></div>
                <div className="cube-move-spot RGYB bluePath6 yellowPath19 greenPath32 redPath45 common-45"></div>
            </div>
            ...
            <div className="horizontal-path">
                <div className="cube-move-spot RGYB bluePath32 yellowPath45 greenPath6 redPath19 common-19"></div>
                <div className="cube-move-spot RGYB bluePath33 yellowPath46 greenPath7 redPath20 common-20"></div>
                <div className="cube-move-spot RGYB bluePath34 yellowPath47 greenPath8 redPath21 common-21"></div>
                ...
                <div className="cube-move-spot RGYB bluePath42 yellowPath3 greenPath16 redPath29 common-29"></div>
                <div className="cube-move-spot RGYB bluePath41 yellowPath2 greenPath15 redPath28 common-28"></div>
                <div
                    className="cube-move-spot tokenStart yellow-spot RGYB bluePath40 yellowPath1 greenPath14 redPath27 common-27">
                </div>
                <div className="cube-move-spot R  G B bluePath39 greenPath13 redPath26 common-26"></div>
            </div>
