    ...
    return (
        <div className="1st-half equal-up-down">
            ...
            <div className="vertical-path">
                ...
                <div className="cube-move-spot green-spot G greenPath52 common-5"></div>
                ...
                <div className="cube-move-spot green-spot G greenPath55 common-14"></div>
                ...
                <div className="cube-move-spot green-spot G greenPath56 common-17"></div>
